                ...
                <div class="card-body">
                    ...
                    <form action="<?= URLROOT ?>/admin/Products/create" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" id="color_select" name="color_select" onchange="toggleCustomColor()" style="height: auto;">
                                    ...
                                    <option value="other" class="fw-bold text-primary">+ Khác...</option>
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="checkbox" class="form-check-input" id="size_<?= $s ?>" name="sizes[]" value="<?= $s ?>">
                        ...
                        <div class="mb-3 border p-3 bg-light rounded">
                            <label class="fw-bold">Hình ảnh sản phẩm (Tối đa 5 ảnh)</label>
                            <input type="file" class="form-control mb-2" id="images" multiple accept="image/*" onchange="handleFileSelect(event)">
                            <small class="text-muted d-block mb-3">Đã chọn <span id="image-count">0</span>/5 ảnh. <span class="text-danger">(*) Chọn vào nút tròn để làm ảnh chính.</span></small>
