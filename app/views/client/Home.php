	...
	<div class="container mx-auto px-4 py-16 md:py-24">
		<div class="max-w-3xl">
			...
			<p class="mt-5 text-slate-600 text-base md:text-lg leading-relaxed">
				Khám phá bộ sưu tập trang sức cao cấp được chế tác thủ công bởi những nghệ nhân bậc thầy. Chúng tôi mang đến sự sang trọng và đẳng cấp cho phong cách cá nhân của bạn.
			</p>
